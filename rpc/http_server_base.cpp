...
namespace cryptonote::rpc {
  ...
  void http_server_base::jsonrpc_error_response(HttpResponse& res, int code, std::string message, std::optional<epee::serialization_e::storage_entry> id) const
  {
    ...
    std::string body;
    epee::serialization_e::store_t_to_json(rsp, body);
